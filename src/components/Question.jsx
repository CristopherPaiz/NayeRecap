...
function Question() {
  ...
  const trends = ['¿Cómo enamorar a mi novia?', '¿Qué peliculas ver con mi novia?', `¿A las novias le gustan los cuyos?`,]

  const handleSearch = (e) => {
    e.preventDefault()
    if (searchQuery.toLowerCase() === '¿cuánto tiempo hemos estado juntos?' || searchQuery.toLowerCase() === 'cuánto tiempo hemos estado juntos' || searchQuery.toLowerCase() === 'cuanto tiempo hemos estado juntos') {
          navigate("/timer");
       ...
       <div
        ...
        >
          ...
          <div className="mt-8 w-full max-w-[600px]">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-2xl">Búsquedas en tendencia</h2>
        ...
        <div className="flex flex-col min-h-screen w-full max-w-[480px] mx-auto ">
          ...
          <div className='mt-10  px-5 text-white/50'>
            <p>Prueba buscando "¿Cuánto tiempo hemos estado juntos?" ;)</p>
          </div>
        </div>
      )}
    </div>
